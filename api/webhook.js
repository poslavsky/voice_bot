...
- НЕ разрывай предложения на части
- Каждое предложение должно быть на одной строке
- Новый абзац только при смене темы или после длинной паузы
- Пустая строка только между абзацами
...
Формат:
1. Придумай короткий заголовок (одна строка, без форматирования)
2. Раздели на тематические секции
3. Заголовок секции: эмодзи + название (например: 📌 Цели)
4. Под заголовком — буллеты с "• "

Пример:
Утренняя настройка и планы
...
ВАЖНО:
- НЕ используй markdown (никаких ** или __ или #)
- Только простой текст, эмодзи и буллеты •
- Убирай воду и слова-паразиты
- Краткие, ёмкие формулировки
